      ...
      var drawTable = function () {
        ...
        $.each(products, function () {
          ...
          $cartTable.append(
            ...
            '<td><select id="type"><option value="AirPods Pro(第二代)">AirPods Pro(第二代)</option><option value="AirPods Pro(第一代)">AirPods Pro(第一代)</option><option value="AirPods(第三代)">AirPods(第三代)</option><option value="AirPods(第二代)">AirPods(第二代)</option></select></td>' +
